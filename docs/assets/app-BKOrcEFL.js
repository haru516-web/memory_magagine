  ...
  `}function Qi({values:e,selectedId:t,selectedBackground:a,selectedFixedTags:o,freeTagsValue:s,submitLabel:u,headerMini:m,headerTitle:r}){return t==="page8"?`
      <section class="page page--compose page--compose--edit" data-compose-stage="edit">
        ...
        <form class="compose-form compose-form--edit" id="composeForm">
          <section class="compose-editor compose-editor--page8">
            <section class="compose-preview compose-preview--editor compose-preview--page8">
            ...
            <aside class="compose-editor-actions compose-editor-actions--page8">
              ...
              ${Rt(o,s)}
              <button class="button button--primary compose-submit-button compose-submit-button--page8" type="submit">${u}</button>
            </aside>
          </section>
        </form>
      </section>
